...
namespace Microsoft.AspNet.SignalR.Client.Http
{
    public class HttpWebRequestWrapper : IRequest
    {
        ...
        private IDictionary<string, Action<HttpWebRequest, string>> _restrictedHeadersSet =
            new Dictionary<string, Action<HttpWebRequest, string>>()
            {
                ...
                {
                    HttpRequestHeader.TransferEncoding.ToString(),
                    (request, value) => { request.TransferEncoding = value; }
                },
            };
